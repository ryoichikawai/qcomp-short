...
# ## Google Colab
# 
# The rocket icon at the top is known launch button.  Currently, there is only one item "Colab" in it.  This book is linked to [Google Colab](https://colab.research.google.com/).  By clicking "Colab", you open the current page in Google Colab where you can actually edit and run the page.  For example, there is an python code in the current page, you can run it on the google computer.   Furthermore, you can modify the code and run your own version.  See {numref}`sec-Colab` for more information about Google Colab.
