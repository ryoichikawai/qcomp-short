...
# ## Standard Basis sets
# 
# In addition to the computational basis $\{|0\rangle,|1\rangle\}$, we often use other orthonormal basis set, namely $\{|+\rangle, |-\rangle\}$ and $\{|L\rangle,|R\rangle\}$.
...
# 
# ---
# **Exercise** {numref}`%s <sec-single-qubit>`.1 &nbsp;  Assuming that the computational basis is orthonormal, show that basis $\{|+\rangle, |-\rangle\}$ and also $\{|L\rangle, |R\rangle\}$ are orthonormal.
# 
# ---
# 
...
# 
# ---
# **Exercise** {numref}`%s <sec-single-qubit>`.2 &nbsp;  
# 
